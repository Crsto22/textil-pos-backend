    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/pago/**")
                        .hasAnyAuthority("ADMINISTRADOR", "VENTAS", "VENTAS_ALMACEN", "SISTEMA")
                        .requestMatchers(HttpMethod.GET, "/api/config/sucursales/*/metodos-pago")
                        .hasAnyAuthority("ADMINISTRADOR", "VENTAS", "VENTAS_ALMACEN", "SISTEMA")
                        .requestMatchers(HttpMethod.GET, "/api/config/metodos-pago/**")
                        .hasAnyAuthority("ADMINISTRADOR", "VENTAS", "VENTAS_ALMACEN", "SISTEMA")
                        .requestMatchers("/api/config/metodos-pago/**").hasAnyAuthority("ADMINISTRADOR", "SISTEMA")
                        .requestMatchers(HttpMethod.GET, "/api/config/comprobantes/**").hasAnyAuthority("ADMINISTRADOR", "VENTAS", "VENTAS_ALMACEN", "SISTEMA")
                        ...
                        .hasAnyAuthority("ADMINISTRADOR", "VENTAS", "ALMACEN", "VENTAS_ALMACEN", "SISTEMA")
                        .requestMatchers("/api/venta/**").hasAnyAuthority("ADMINISTRADOR", "VENTAS", "VENTAS_ALMACEN", "SISTEMA")
                        .requestMatchers("/api/nota-credito/**")
                        .hasAnyAuthority("ADMINISTRADOR", "VENTAS", "VENTAS_ALMACEN", "SISTEMA")
                        .requestMatchers("/api/cotizacion/**")
                        .hasAnyAuthority("ADMINISTRADOR", "VENTAS", "VENTAS_ALMACEN", "SISTEMA")
